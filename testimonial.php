...
<html lang="en">
    ...
    <body>
            ...
            <div class="container topbar bg-primary d-none d-lg-block">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="top-link pe-2">
                        ...
                        <a href="#" class="text-white"><small class="text-white mx-2">Terminos de usos</small>/</a>
            ...
            <div class="modal-dialog modal-fullscreen">
                <div class="modal-content rounded-0">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Buscar por palabras clave</h5>
        ...
        <div class="container-fluid page-header py-5">
            <h1 class="text-center text-white display-6">Testimonio</h1>
            <ol class="breadcrumb justify-content-center mb-0">
                <li class="breadcrumb-item"><a href="#">Hogar</a></li>
                <li class="breadcrumb-item"><a href="#">Paginas</a></li>
                <li class="breadcrumb-item active text-white">Testimonio</li>
            </ol>
        </div>
        ...
        <div class="container-fluid testimonial py-5">
            <div class="container py-5">
                <div class="testimonial-header text-center">
                    ...
                    <h1 class="display-5 mb-5 text-dark">¡Lo que dice nuestro cliente!</h1>
                </div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-6">
                            <div class="position-relative mx-auto">
                                ...
                                <button type="submit" class="btn btn-primary border-0 border-secondary py-3 px-4 position-absolute rounded-pill text-white" style="top: 0; right: 0;">Suscribete ahora</button>
                            </div>
                        </div>
                        <div class="col-lg-3">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        <span class="text-light"><a href="#"><i class="fas fa-copyright text-light me-2"></i>Nombre de su sitio</a>, Todos los derechos reservados.</span>
                    </div>
