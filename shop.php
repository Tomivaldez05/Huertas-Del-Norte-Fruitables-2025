...
?>
        ...
        <div class="container-fluid fruite py-5">
            <div class="container py-5">
                <h1 class="mb-4">Tienda de frutas frescas</h1>
                <div class="row g-4">
                    <div class="col-lg-12">
                        <div class="row g-4">
                            <div class="col-xl-3">
                                <div class="input-group w-100 mx-auto d-flex">
                                    <input type="search" id="input-busqueda" class="form-control p-3" placeholder="Buscar" aria-describedby="search-icon-1">
                                    <span id="search-icon-1" class="input-group-text p-3"><i class="fa fa-search"></i></span>
                                </div>
                            </div>
                            <div class="col-6"></div>
                            <div class="col-xl-3">
                                <div class="bg-light ps-3 py-3 rounded d-flex justify-content-between mb-4">
                                    <label for="fruits">Clasificacion predeterminada:</label>
                                    <select id="fruits" name="fruitlist" class="border-0 form-select-sm bg-light me-3" form="fruitform">
                                        <option value="volvo">No</option>
                                        <option value="saab">Popularidad</option>
                                        <option value="opel">Orgánico</option>
                            ...
                            <div class="col-lg-3">
                                <div class="row g-4">
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            <h4>Categorias</h4>
                                            <ul class="list-unstyled fruite-categorie" id="lista-categorias">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="range" class="form-range w-100" id="sliderPrecio"  min="0" max="500" value="0" >
                                            <output id="valorPrecio" min-velue="0" max-value="500" for="rangeInput">0</output>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-lg-12">
                                        <h4 class="mb-3">Productos caracteristicos</h4>
                            ...
                            <div class="col-lg-9">
                                <div class="row g-4 justify-content-center">            
                                    <div class="row" id="contenedor-productos">
                                        <!-- Aquí se insertarán dinámicamente las cards -->
                                    </div>
                                    <div class="text-center mt-4">
                                        <button id="btn-cargar-mas" class="btn btn-outline-primary rounded-pill px-4">
                                            ↓ Cargar más
                                        </button>
                                    </div>
                                </div>
